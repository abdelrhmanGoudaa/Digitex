...
class User(http.Controller):
    ...
    @http.route('/user_all_event', methods=['POST'], type='json', auth='publicpublicpublicpublic')
        ...
        if user:
            ...
            if attendence:
                ...
                for rec in attendence:
                    ...
                    result['check_out'] = rec.check_out
                    list_of_result.append(result)
                return {
                    "success": {
                        "msg": "Available Attendences",
                        "data": list_of_result
                    }
                }
            else:
